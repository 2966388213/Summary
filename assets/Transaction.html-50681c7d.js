import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-f6611fe2.js";const o={},i=e(`<h1 id="事务" tabindex="-1"><a class="header-anchor" href="#事务" aria-hidden="true">#</a> 事务</h1><p>在存储过程中使用事务是为了确保一系列的SQL语句要么全部执行成功，要么全部失败，保持数据库的一致性。在SQL Server中，你可以使用 <code>BEGIN TRANSACTION</code> 开始事务，<code>COMMIT</code> 提交事务，以及 <code>ROLLBACK</code> 回滚事务。</p><p>以下是一个简单的存储过程示例，展示如何使用事务：</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">PROCEDURE</span> YourStoredProcedure
