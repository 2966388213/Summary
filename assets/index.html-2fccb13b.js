import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as t}from"./app-d03b5bc4.js";const p={},e=t(`<h1 id="uniapp-微信端" tabindex="-1"><a class="header-anchor" href="#uniapp-微信端" aria-hidden="true">#</a> uniApp - 微信端</h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p>微信端的配置</p></div><h2 id="manifest-配置" tabindex="-1"><a class="header-anchor" href="#manifest-配置" aria-hidden="true">#</a> manifest 配置</h2><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token property">&quot;mp-weixin&quot;</span> <span class="token operator">:</span> <span class="token punctuation">{</span>
